...
var AdwaitaDarkScheme = map[fyne.ThemeColorName]color.Color{
	theme.ColorNameOverlayBackground: color.RGBA{0x24, 0x24, 0x24, 0xff},
	...
	theme.ColorNameDisabled:          color.RGBA{0xff, 0xff, 0xff, 0x80},
	theme.ColorNameDisabledButton:    color.RGBA{0x24, 0x24, 0x24, 0x80},
	theme.ColorNameError:             color.RGBA{0xc0, 0x1c, 0x28, 0xff},
}

// AdwaitaLight scheme
var AdwaitaLightScheme = map[fyne.ThemeColorName]color.Color{
	theme.ColorNameOverlayBackground: color.RGBA{0xfa, 0xfa, 0xfa, 0xfa},
	...
	theme.ColorNameDisabled:          color.RGBA{0x0, 0x0, 0x0, 0x80},
	theme.ColorNameDisabledButton:    color.RGBA{0xfa, 0xfa, 0xfa, 0x80},
