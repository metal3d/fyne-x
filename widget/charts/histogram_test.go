...
func createTestHistoChart() *HistrogramChart {
	return NewHistrogramChart(nil)
}

func createTestHistoChartWithOptions() *HistrogramChart {
	return NewHistrogramChart(&LineCharthOpts{
